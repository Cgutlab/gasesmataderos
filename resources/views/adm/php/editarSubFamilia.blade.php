...
<div class="row">
    ...
    {!! Form::model($familia, array('route' => array('subfamilia.update', $familia->id), 'method' => 'PUT', 'files'=> true))!!}
    ...
    {{ csrf_field() }}
        ...
        <div class="form-group col-sm-12 pad-panel" >
            ...
            {!! Form::select('familia', $familias ,$familia->familia ,['class' => 'form-control','required'])!!}
        </div>
