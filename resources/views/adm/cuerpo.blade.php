    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">Panel de administraci&oacute;n - Gases Mataderos</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                     ...
                     <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('servicio.index') }}">Editar servicios</a>
                                </li>
                            </ul>
                        </li> 
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('subfamilia.index') }}">Editar subfamilia</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="glyphicon glyphicon-th"></i> Garantia<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('contenidodes.index') }}">Editar contenido</a>
                                </li>
                                <li>
                                    <a href="{{ route('descarga.index') }}">Editar descargas</a>
                                </li>
                            </ul>
                        </li>
                         <li>
                            <a href="#"><i class="glyphicon glyphicon-th"></i> Post-ventas<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('postventa.index') }}">Editar contenido</a>
                                </li>
                            </ul>
                        </li> 
                        {{-- <li>
